...
public class UserTestData {
    ...
    public static void init() {
        ADMIN = new User("Admin", "admin@javaops.ru", UserFlag.superuser, "kiv");
        DELETED = new User("Deleted", "deleted@yandex.ru", UserFlag.deleted, "kiv");
        FULL_NAME = new User("Full Name", "gmail@gmail.com", UserFlag.active, "kiv");
        USER1 = new User("User1", "user1@gmail.com", UserFlag.active, "kiv");
